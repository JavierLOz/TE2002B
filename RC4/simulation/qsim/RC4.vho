...
-- X[1]	=>  Location: PIN_A7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[2]	=>  Location: PIN_J11,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Y[3]	=>  Location: PIN_B12,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF RC4 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \I0|I1|S~0_combout\ : std_logic;
SIGNAL \X[1]~input_o\ : std_logic;
SIGNAL \I0|Co~0_combout\ : std_logic;
SIGNAL \Y[1]~input_o\ : std_logic;
SIGNAL \I1|I1|S~combout\ : std_logic;
...
SIGNAL \I3|Co~0_combout\ : std_logic;
...
\I0|I1|S~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \I0|I1|S~0_combout\ = \X[0]~input_o\ $ (\Y[0]~input_o\ $ (\Cin~input_o\))
...
\I0|Co~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \I0|Co~0_combout\ = (\X[0]~input_o\ & ((\Y[0]~input_o\) # (\Cin~input_o\))) # (!\X[0]~input_o\ & (\Y[0]~input_o\ & \Cin~input_o\))
...
\I1|I1|S\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \I1|I1|S~combout\ = \X[1]~input_o\ $ (\I0|Co~0_combout\ $ (\Y[1]~input_o\))
...
PORT MAP (
	datab => \X[1]~input_o\,
	datac => \I0|Co~0_combout\,
	datad => \Y[1]~input_o\,
	combout => \I1|I1|S~combout\);

-- Location: LCCOMB_X50_Y53_N22
\I1|Co~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \I1|Co~0_combout\ = (\X[1]~input_o\ & ((\I0|Co~0_combout\) # (\Y[1]~input_o\))) # (!\X[1]~input_o\ & (\I0|Co~0_combout\ & \Y[1]~input_o\))
...
-- Equation(s):
-- \I2|I1|S~combout\ = \I1|Co~0_combout\ $ (\X[2]~input_o\ $ (\Y[2]~input_o\))
...
\I2|Co~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \I2|Co~0_combout\ = (\I1|Co~0_combout\ & ((\X[2]~input_o\) # (\Y[2]~input_o\))) # (!\I1|Co~0_combout\ & (\X[2]~input_o\ & \Y[2]~input_o\))
...
-- Equation(s):
-- \I3|I1|S~combout\ = \X[3]~input_o\ $ (\Y[3]~input_o\ $ (\I2|Co~0_combout\))
...
\I3|Co~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \I3|Co~0_combout\ = (\X[3]~input_o\ & ((\Y[3]~input_o\) # (\I2|Co~0_combout\))) # (!\X[3]~input_o\ & (\Y[3]~input_o\ & \I2|Co~0_combout\))
