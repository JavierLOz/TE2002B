...
ARCHITECTURE structure OF Decoder7segmentosCase IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \Mux0~0_combout\ = (\S[2]~input_o\ & (!\S[1]~input_o\ & (\S[3]~input_o\ $ (!\S[0]~input_o\)))) # (!\S[2]~input_o\ & (\S[0]~input_o\ & (\S[1]~input_o\ $ (!\S[3]~input_o\))))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\S[1]~input_o\ & ((\S[0]~input_o\ & ((\S[3]~input_o\))) # (!\S[0]~input_o\ & (\S[2]~input_o\)))) # (!\S[1]~input_o\ & (\S[2]~input_o\ & (\S[3]~input_o\ $ (\S[0]~input_o\))))
...
-- Equation(s):
-- \Mux2~0_combout\ = (\S[2]~input_o\ & (\S[3]~input_o\ & ((\S[1]~input_o\) # (!\S[0]~input_o\)))) # (!\S[2]~input_o\ & (\S[1]~input_o\ & (!\S[3]~input_o\ & !\S[0]~input_o\)))
...
-- Equation(s):
-- \Mux3~0_combout\ = (\S[1]~input_o\ & ((\S[2]~input_o\ & ((\S[0]~input_o\))) # (!\S[2]~input_o\ & (\S[3]~input_o\ & !\S[0]~input_o\)))) # (!\S[1]~input_o\ & (!\S[3]~input_o\ & (\S[2]~input_o\ $ (\S[0]~input_o\))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (\S[1]~input_o\ & (((!\S[3]~input_o\ & \S[0]~input_o\)))) # (!\S[1]~input_o\ & ((\S[2]~input_o\ & (!\S[3]~input_o\)) # (!\S[2]~input_o\ & ((\S[0]~input_o\)))))
...
-- Equation(s):
-- \Mux5~0_combout\ = (\S[1]~input_o\ & (!\S[3]~input_o\ & ((\S[0]~input_o\) # (!\S[2]~input_o\)))) # (!\S[1]~input_o\ & (\S[0]~input_o\ & (\S[2]~input_o\ $ (!\S[3]~input_o\))))
...
-- Equation(s):
-- \Mux6~0_combout\ = (\S[0]~input_o\ & ((\S[3]~input_o\) # (\S[1]~input_o\ $ (\S[2]~input_o\)))) # (!\S[0]~input_o\ & ((\S[1]~input_o\) # (\S[2]~input_o\ $ (\S[3]~input_o\))))
