...
\I1|S~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \I1|S~0_combout\ = \Cin~input_o\ $ (\B~input_o\ $ (\A~input_o\))
...
\Co~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Co~0_combout\ = (\Cin~input_o\ & ((\B~input_o\) # (\A~input_o\))) # (!\Cin~input_o\ & (\B~input_o\ & \A~input_o\))
